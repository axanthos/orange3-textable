...
def count_in_window(
    ...
    if (
        ...
        if units['seq_length'] > 1:
            ...
            # Update main counts...
            freq = dict(
                [((u'1', k), v) for (k, v) in iteritems(window_freq)]
            )
    ...
    if contexts['segmentation'] is not None and units is not None:
        ...
        # Else get the list of contexts in final format...
            ...
            if context_annotation_key is not None:
                ...
                context_list = [
                    c.get_content() for c in context_segmentation if c is not None
                    ]
            ...
            if averaging_std_deviation:
                ...
                if contexts['merge']:
                    ...
                    if n < 2:
                        ...
                        stdev = sqrt(stats[context_type][2] / (stats[context_type][0] - 1))
